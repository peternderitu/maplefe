          ...
          <div className='lg:grid grid-cols-4 gap-4'>
            {filterApprovedDeals().length > 0 ? (
              ...
              <div className='mx-auto col-span-12'>
                <img src="dealsComingSoon.svg" className="mb-3 h-72"/>
                <p className="text-center font-playfair text-2xl text-burgundy300 font-semibold">Great deals coming soon!</p>
              </div>
            ) }
          </div>
        </div>
