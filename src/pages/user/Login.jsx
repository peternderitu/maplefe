      ...
      <div className='flex items-center flex-col h-screen bg-authBg bg-cover bg-no-repeat bg-center'>
        ...
        <Card className='lg:w-[450px] h-max border-none shadow-none bg-transparent'>
          ...
          <CardFooter className='block'>
            <Button className='w-full font-semibold mb-3' onClick={handleLogin}>
              Login
            </Button>
            {/* <button className='w-full font-semibold border border-burgundy300 p-2 text-sm rounded-md' onClick={()=> navigate('/login-with-google')}>
              Login with Google
            </button> */}
            ...
            <a
              ...
              className='pt-2 text-center text-burgundy500 underline block mx-auto mb-3'
            >
              Forgot password?
            </a>
