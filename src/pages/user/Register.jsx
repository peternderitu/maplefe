      ...
      <div className='flex items-center flex-col h-screen bg-authBg bg-cover bg-no-repeat bg-center'>
        ...
        <Card className='lg:w-[450px] h-max border-none shadow-none bg-transparent'>
          ...
          <CardFooter className='block'>
            ...
            {/* <h3 className='text-2xl text-grey300 text-center mt-5'>Join as a guest using a social account</h3>
            <p className="text-center text-sm text-grey300 font-light pt-0">A school email address will be required in 6 months to continue accessing deals.</p>
            <button className='w-full font-semibold border border-burgundy300 p-2 text-sm rounded-md mb-5 mt-5' onClick={()=> navigate('/login-with-google')}>
              Login with Google
            </button> */}
            <a href="/deals" className='block mx-auto text-center text-burgundy500 font-bold mb-3' >Browse deals as a guest</a>
